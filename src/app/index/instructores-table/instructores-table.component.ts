...
@Component({
  selector: 'app-instructores-table',
  templateUrl: './instructores-table.component.html',
  styleUrls: ['./instructores-table.component.css']
})
export class InstructoresTableComponent implements OnInit {
